        ...
        success: function(data) {
            ...
            $.each(data, function( index ) {
                table.row.add([
                        ...
                        "<select name='cars' id='cargo'><option value='supervisor'>Supervisor</option> <option value='em-a'>Electromecanico A</option><option value='em-b'>Electromecanico B</option><option value='otro'>Otro</option></select>",
