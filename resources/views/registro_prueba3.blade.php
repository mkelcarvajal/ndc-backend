                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Subir Planilla Prueba 3 </h5>
                            </div>
                            <div class="card-body">
                                <form method="post" action="importarExcel_prueba3" enctype="multipart/form-data" id="form_prueba3">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="excel_prueba3" name="excel_prueba3" class="form-control" readonly>
                                                    <div class="input-group-btn">
                                                        <span class="fileUpload btn btn-primary">
                                                            <span class="upl" id="upload"><i class="fas fa-file-excel"></i> </span>
                                                            <input type="file" class="upload up" id="prueba3" name="prueba3"  required accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <br>
                                    <button class="btn btn-primary btn-block" type="submit"><i class="fas fa-file-upload"></i> Subir </button> 
                                </form>
